...
![01](https://github.com/CiroLee/blog/static/mydata/article_images/editor_01.png)         

   ![](https://github.com/CiroLee/blog/static/mydata/article_images/editor_2.png)        
...
​    ![](https://github.com/CiroLee/blog/static/mydata/article_images/editor_3.png)    

注意：全景主文件必须是tour.xml和tour.swf，且位于根目录；     

2.点击右上角齿轮图标，打开工具栏：

   ![](https://github.com/CiroLee/blog/static/mydata/editor_4.png)         

     

3.右侧彩色图标为各个工具，左侧下拉列表会罗列出可编辑的热点。首先选择要编辑的热点，然后点击右侧工具进行编辑。      

   ![](https://github.com/CiroLee/blog/static/mydata/article_images/editor_5.png)

    

4.编辑结束后会弹出结果复制提示，然后把结果粘贴到对应代码处就可以啦！    

​    ![](https://github.com/CiroLee/static/mydata/article_images/editor_2.png)
